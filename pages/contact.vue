        ...
        <div class="basis-1/2">
            <div class="flex flex-col space-y-4">
                ...
                <div class="pb-10">
                    ...
                    <div v-for="number in contacts.phoneNumbers"
                         class="md:text-3xl text-xl font-ABCbold last:mb-0 mb-5">
                        <a :href="'tel: '+number">
                            {{ number }}
                        </a></div>
                </div>
                <div class="pb-10">
                    ...
                    <div class="md:text-3xl text-xl font-ABCbold">
                        <a :href="'http://www.google.com/maps/place/' + contacts.addressX + ',' + contacts.addressY"
                           target="_blank">
                            {{ contacts.address }}
                        </a>
                    </div>
                ...
                <form id="contactForm" class="flex flex-col">
                    ...
                    <div class="flex md:flex-row flex-col mt-10">
                        ...
                        <div class="lg:text-lg md:text:sm text:xs md:ml-5 text-center align-middle">
                            <a href="https://policies.google.com/terms?hl=en-US" class="leading-[2.5]" target="_blank">I
                                ACCEPT THE TERMS & CONDITIONS OF THE WEBSITE*</a>
                        </div>
                    </div>
                    <button type="submit" form="contactForm" value="Submit"
                            class="mt-10 ml-auto mr-auto md:mr-0 text-xs md:text-2xl" @click="handleSubmit">
                        <Chip
                            :text="'SEND'"
                            :isButton="true">
                        </Chip>
